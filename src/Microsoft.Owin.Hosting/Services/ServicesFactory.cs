...
namespace Microsoft.Owin.Hosting.Services
{
    ...
    public static class ServicesFactory
    {
        ...
        public static IServiceProvider Create(IDictionary<string, string> settings, Action<ServiceProvider> configuration)
        {
            ...
            // 将所有Service实现并放到ServiceProvider中
            // settings，自定义实现的Service
        ...
        {
            // service为接口，implementation为具体实现
            DoCallback((service, implementation) =>
            {
                // settings 自定义实现的Service，替代原有的Service, 有多个实现用';'隔开
        ...
        private static void DoCallback(Action<Type, Type> callback) // 这里的callback是line 130 里 (service, implementation) => { } 部分
        {
